...
static bool insert_pumpfun(struct db_writer *writer, const yurei_event_t *event) {
    ...
    PGresult *res = PQexecParams(
        writer->conn,
        "INSERT INTO pumpfun_trades (tx_signature, mint, trader, creator, side, sol_amount, token_amount, fee_bps, fee_lamports, creator_fee_bps, creator_fee_lamports, virtual_sol_reserves, virtual_token_reserves, real_sol_reserves, real_token_reserves)"
...
static bool insert_raydium(struct db_writer *writer, const yurei_event_t *event) {
    ...
    PGresult *res = PQexecParams(
        writer->conn,
        "INSERT INTO raydium_swaps (tx_signature, pool, user_owner, amount_in, amount_out) VALUES ($1,$2,$3,$4,$5)",
        5,
        NULL,
        params,
        NULL,
